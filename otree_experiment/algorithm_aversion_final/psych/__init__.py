...
class Player(BasePlayer):
    ...
    loc4 = make_bf("If a person is socially or politically active, they can have an effect on social conditions.")
...
# removing payment for control questions
...
page_sequence = [Intro_Psych,BigFive, BigFive2, LoC, Trust, Trust2, Trust3, Final_page]
